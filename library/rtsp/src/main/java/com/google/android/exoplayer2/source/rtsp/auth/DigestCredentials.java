...
public final class DigestCredentials extends Credentials {
    ...
    public final String getAuthorizationToken(String uri, String method, String messageBody) {
        ...
        if ("auth".equals(getQop()) || "auth-int".equals(getQop())) {
        ...
        Credentials credentials = new DigestCredentials.Builder(newCredentials)
            .setParam(DigestCredentials.URI, uri)
            .setParam(DigestCredentials.USERNAME, getUsername())
            .setParam(DigestCredentials.RESPONSE, digestAuthCipher.getToken())
            .build();
